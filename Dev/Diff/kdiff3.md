...
Debian 9.13 Stretch. However `kiff3` under Debian 10 Buster is useless. I am
...
The new version seems to be under active development, and provides a port to
Qt5, but lacks basic functionality (see conclusion later).
...
old version `kdiff3` 0.9.98. No guarantee. It seems to be an example of
software 'innovation' were the application now supports Qt5 instead of Qt4 and
